...
export const metadata: Metadata = {
  title: 'Pricing | NatureQuery — Free Plan Available',
  description:
    'NatureQuery pricing plans: Free (50 queries/month), Pro ($19/month), and Enterprise. Start free — no credit card required. Upgrade anytime.',
  keywords: [
    'NatureQuery pricing',
    'AI SQL tool pricing',
