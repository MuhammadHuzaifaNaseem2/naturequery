...
function applySecurityHeaders(res: NextResponse): NextResponse {
  ...
  res.headers.set(
    ...
    [
      ...
      "font-src 'self' data:",
      "connect-src 'self' https://api.groq.com https://api.stripe.com https://js.stripe.com wss: https://*.sentry.io https://*.ingest.sentry.io https://us.i.posthog.com https://us-assets.i.posthog.com",
...
export const config = {
  matcher: [
    '/((?!api/auth|api/webhooks|_next/static|_next/image|favicon\\.ico|sitemap\\.xml|robots\\.txt|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico)$).*)',
  ],
}
