...
-- CreateIndex
CREATE INDEX "DatabaseConnection_teamId_idx" ON "DatabaseConnection"("teamId");

-- CreateIndex
CREATE INDEX "SavedQuery_userId_idx" ON "SavedQuery"("userId");

-- CreateIndex
CREATE INDEX "SavedQuery_teamId_idx" ON "SavedQuery"("teamId");

-- CreateIndex
CREATE INDEX "SavedQuery_isPublic_idx" ON "SavedQuery"("isPublic");
...
-- AddForeignKey
ALTER TABLE "DatabaseConnection" ADD CONSTRAINT "DatabaseConnection_teamId_fkey" FOREIGN KEY ("teamId") REFERENCES "Team"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "SavedQuery" ADD CONSTRAINT "SavedQuery_teamId_fkey" FOREIGN KEY ("teamId") REFERENCES "Team"("id") ON DELETE SET NULL ON UPDATE CASCADE;
